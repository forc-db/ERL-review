...
**As in the response above, we have eliminated unnecessary/confusing mention of ForC-simplified. The version used is ForC v3.0 (to be released with DOI upon acceptance of this manuscript). We do not feel it is necessary to state the version number every time ForC is mentione.**
