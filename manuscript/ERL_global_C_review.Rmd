...
The most notable exception to the pattern of decreasing flux from tropical to boreal biomes was $NEP$, with no significant differences across biomes but with the largest average in temperate broadleaf forests, followed by tropical, boreal, and temperate conifer forests (Figs. `r flux_age_trends`, `rNEP_fig`).
