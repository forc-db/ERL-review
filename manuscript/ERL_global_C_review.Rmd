...
We have also added data from individual publications, with a particular focus on productivity [@banbury_morgan_global_nodate; e.g., @taylor_temperature_2017], dead wood, and ForestGEO sites [e.g., @lutz_global_2018, @johnson_climate_2018].
...
To test for differences across mature forest biomes, we also examined how stand age impacted fluxes and stocks, employing a mixed effects model ['lmer' function in 'lme4' R; @bates_fitting_2015] with biome as fixed effect and plot nested within geographic.area as random effects on the intercept.
