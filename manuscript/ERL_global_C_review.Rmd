...
Data were summarized to produce schematics of C cycling for mature forests of each biome.
...
Our study reveals that most C fluxes quickly increase and then decelerate as stands age (Figs. `r flux_age_trends`, `r age_trends_all`), consistent with current understanding of age trends in forest C cycling [Fig. `r schematic`; e.g., @andersonteixeira_altered_2013; @amiro_ecosystem_2010; @magnani_human_2007].
