...
```{r eval = generate_figures, echo=FALSE, fig.align = "center", fig.cap =TrB_age_trends_caption, out.width='100%', fig.pos='H'}
  ...
  knitr::include_graphics("tables_figures/stacked_age_trends/Tropical broadleaf_age_trends.png")
```


```{r eval = generate_figures, echo=FALSE, fig.align = "center", fig.cap =TeB_age_trends_caption, out.width='100%', fig.pos='H'}

  knitr::include_graphics("tables_figures/stacked_age_trends/Temperate broadleaf_age_trends.png")
```


```{r eval = generate_figures, echo=FALSE, fig.align = "center", fig.cap =TeN_age_trends_caption, out.width='100%', fig.pos='H'}

  knitr::include_graphics("tables_figures/stacked_age_trends/Temperate conifer_age_trends.png")
```


```{r eval = generate_figures, echo=FALSE, fig.align = "center", fig.cap =BoN_age_trends_caption, out.width='100%', fig.pos='H'}

  knitr::include_graphics("tables_figures/stacked_age_trends/Boreal conifer_age_trends.png")
```
...
There were also some substantial discrepancies between 
*(paragraph on young vs mature)*
...
The majority of flux variables, together with most live biomass pools, increased significantly with stand age (Table 1; Figs. `r flux_age_trends`- `r stock_age_trends`, `r all_age_trends`).
...
Our study reveals that most C fluxes quickly increase to a plateau as stands age (Fig. `r flux_age_trends`), consistent with current understanding of age trends in forest C cycling [e.g., @andersonteixeira_altered_2013; @amiro_ecosystem_2010; @magnani_human_2007].
