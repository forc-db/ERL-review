...
In **four of the six** cases (**$B_{tot}$, $B_{ag-wood}$,  $B_{root-coarse}$, $DW_{tot}$**), temperate conifer forests were in the highest significance grouping, and boreal forests in the lowest, with tropical and temperate broadleaf forests  in between--most commonly being significantly different from temperate conifer but not boreal forests.
...
Both C stocks and fluxes commonly displayed significant trends with stand age for within-biome analyses (Tables 1, S2, Figs. 6-11, S1-S26; detailed below).
