...
n_focal_variable_records_eligible_for_inclusion <- NA # records_eligible_for_inclusion, limited to focal variables
...
n_plots_tot <- NA #total numbers of plots used in the analysis (all variables combined)
n_areas_tot <- NA #total numbers of areas used in the analysis (all variables combined)
