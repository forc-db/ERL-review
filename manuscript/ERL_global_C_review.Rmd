...
... 
*(These differences are driven more by geographic distribution of sampling than by true differences.)*
...
(**check paragraph with latest data**) Average C cycles for forests <100 years old are presented in Figures 8-11.  Both C stocks and fluxes commonly displayed significant trends with stand age for within-biome analyses (Table 1, Figs. 5-10, S1-S26; detailed below). Differences across biomes typically paralleled those observed for mature forests, with C cycling generally most rapid in the tropics and slowest in boreal forests (Figs. 6-7).  
