...
There were enough data to run this analysis for all focal variables but **$R_{auto-ag}$ and $DW_{down}$**.
...
The C cycle budgets for mature forests (Figs. 2-5) generally "close"--that is, the sums of component variables do not differ significantly from the larger fluxes.
