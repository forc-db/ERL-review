...
*These groupings were defined based on ForC v.2.0 [@anderson-teixeira_forc_2018], for which they covered 91% of the primary variable records for forests of known age, or 86% of total records. The most well-represented forest types excluded were boreal broadleaf and boreal and temperate mixed broadleaf-needleleaf, each with <400 records total for stands of any age.*
