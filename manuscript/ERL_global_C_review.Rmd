...
In the past *couple of/several* decades, researchers have started asking how age trends--mostly in biomass accumulation-- vary across biomes.
*(look up early work on this--citations in @anderson_temperature-dependence_2006)*
@anderson_temperature-dependence_2006
@chazdon_carbon_2016, 
Tepley et al., 
@cook-patton_mapping_2020
There has been little synthesis of differences in variables other than C stocks or their accumulation rates.
...
Here, conduct a data-based review of carbon cycling from a stand to global level, and by biome and stand age, using the largest global compilation of forest carbon data, which is available in our open source Global Carbon Forest database (*ForC*; Fig. `r figure_map`).
